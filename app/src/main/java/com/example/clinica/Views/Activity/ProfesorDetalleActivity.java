...
public class ProfesorDetalleActivity extends AppCompatActivity implements CursoAdapter.CursoAdapterListener {
    ...
    private void getCursos(int id){
        ...
        callCursos.enqueue(new Callback<List<Curso>>() {
            ...
            public void onResponse(Call<List<Curso>> call, Response<List<Curso>> response) {
                ...
                adapter = new CursoAdapter(cursos,ProfesorDetalleActivity.this);
    ...
    public void OnItemClicked(int id) {
        Intent i = new Intent(ProfesorDetalleActivity.this,CursoDetalleActivity.class);
        i.putExtra("id",id);
        startActivity(i);
    }
}
