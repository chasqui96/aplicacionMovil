package com.example.clinica.Data.util;
...
public class Metodos {
    ...
    public static String convertirListaATexto(List<Especialidad> lista){
        Gson gson = new Gson();

        return gson.toJson(lista);
    }

    public static List<Especialidad> convertirTextoALista(String cadena){
        Gson gson = new Gson();

        Type lista = new TypeToken<List<Especialidad>>(){}.getType();
